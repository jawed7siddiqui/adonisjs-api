...
exports.default = Env_1.default.rules({
    ...
    APP_URL: Env_1.default.schema.string.optional(),
    ...
    PG_HOST: Env_1.default.schema.string.optional({ format: 'host' }),
    PG_PORT: Env_1.default.schema.number.optional(),
    PG_USER: Env_1.default.schema.string.optional(),
    PG_PASSWORD: Env_1.default.schema.string.optional(),
    PG_DB_NAME: Env_1.default.schema.string.optional(),
    GOOGLE_CLIENT_ID: Env_1.default.schema.string.optional(),
    GOOGLE_CLIENT_SECRET: Env_1.default.schema.string.optional(),
    FACEBOOK_CLIENT_ID: Env_1.default.schema.string.optional(),
    FACEBOOK_CLIENT_SECRET: Env_1.default.schema.string.optional(),
});
